...
<span style="color:#fbde2d">public</span> <span style="color:#fbde2d">class</span> <span style="color:#ff6400">Main</span> {
    ...
    <span style="color:#fbde2d">public</span> <span style="color:#fbde2d">static</span> <span style="color:#fbde2d">void</span> <span style="color:#ff6400">main</span>(<span style="color:#fbde2d">String</span>[] args) {
        ...
        numbers<span style="color:#fbde2d">.</span>sort(<span style="color:#fbde2d">new</span> <span style="color:#fbde2d">Comparator&lt;<span style="color:#fbde2d">Integer</span>></span>() {

            <span style="color:#fbde2d">@Override</span>
            <span style="color:#fbde2d">public</span> <span style="color:#fbde2d">int</span> <span style="color:#ff6400">compare</span>(<span style="color:#fbde2d">Integer</span> arg0, <span style="color:#fbde2d">Integer</span> arg1) {
                <span style="color:#fbde2d">return</span> arg0 <span style="color:#fbde2d">-</span> arg1;
            }
