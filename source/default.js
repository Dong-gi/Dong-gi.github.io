const posts = {
    list: [
        ...
        { category: 'JavaScript', file: '/posts/language/javascript/basic.html', title: '코어 JavaScript' },
        { category: 'JavaScript', file: '/posts/language/javascript/basic2.html', title: '브라우저 JavaScript' },
        { category: 'JavaScript', file: '/posts/language/javascript/jquery.html', title: 'jQuery' },
        { category: 'JavaScript', file: '/posts/language/javascript/node.html', title: 'Node' },
        { category: 'JVM', file: '/posts/language/jvm/android.html', title: 'Android' },
        { category: 'JVM', file: '/posts/language/jvm/basic.html', title: 'Java 시작하기' },
        { category: 'JVM', file: '/posts/language/jvm/effective_java.html', title: '『Effective Java』' },
        { category: 'JVM', file: '/posts/language/jvm/groovy.html', title: 'Groovy' },
        { category: 'JVM', file: '/posts/language/jvm/javax.annotation.processing.html', title: 'Annotation Processing API' },
        { category: 'JVM', file: '/posts/language/jvm/jni.html', title: 'Java Native Interface' },
        { category: 'JVM', file: '/posts/language/jvm/performance.html', title: 'JVM 옵션 및 성능 관련사항' },
        { category: 'JVM', file: '/posts/language/jvm/version.html', title: 'Java 버전별 추가사항' },
        { category: 'JVM/Library', file: '/posts/language/jvm/apache.commons.collections.html', title: 'Apache Commons Collections 4.4' },
        { category: 'JVM/Library', file: '/posts/language/jvm/apache.commons.lang.html', title: 'Apache Commons Lang 3.9' },
        { category: 'JVM/Library', file: '/posts/language/jvm/apache.commons.math.html', title: 'Apache Commons Math 3.6.1' },
        { category: 'JVM/Library', file: '/posts/language/jvm/apache.commons.rng.html', title: 'Apache Commons RNG Core 1.2' },
        { category: 'JVM/Library', file: '/posts/language/jvm/com.sun.nio.sctp.html', title: 'com.sun.nio.sctp Since 1.7' },
        { category: 'JVM/Library', file: '/posts/language/jvm/freemarker_built_in.html', title: 'FreeMarker Built-in 목록 2.3.28' },
        { category: 'JVM/Library', file: '/posts/language/jvm/freemarker_programming_guide.html', title: 'FreeMarker 프로그래밍 가이드 2.3.28' },
        { category: 'JVM/Library', file: '/posts/language/jvm/freemarker_template_guide.html', title: 'FreeMarker 템플릿 작성 가이드 2.3.28' },
        { category: 'JVM/Library', file: '/posts/language/jvm/freemarker_xml_guide.html', title: 'FreeMarker XML 처리 가이드 2.3.28' },
        { category: 'JVM/Library', file: '/posts/language/jvm/gson.html', title: 'Gson 2.8.6' },
        { category: 'JVM/Library', file: '/posts/language/jvm/guava.html', title: 'Guava 30.1' },
        { category: 'JVM/Library', file: '/posts/language/jvm/jackson.html', title: 'Jackson 2.10.1' },
        { category: 'JVM/Library', file: '/posts/language/jvm/java.base.html', title: 'java.base 16' },
        { category: 'JVM/Library', file: '/posts/language/jvm/java.net.http.html', title: 'java.net.http 16' },
        { category: 'JVM/Library', file: '/posts/language/jvm/logback.html', title: 'Logback with SLF4J' },
        { category: 'JVM/Library', file: '/posts/language/jvm/lombok.html', title: 'lombok 1.18.10' },
        { category: 'JVM/Web', file: '/posts/language/jvm/java_ee.html', title: 'JavaEE' },
        { category: 'JVM/Web', file: '/posts/language/jvm/jpa.html', title: 'JPA; Java Persistence API' },
        { category: 'JVM/Web', file: '/posts/language/jvm/netty.html', title: 'Netty' },
        { category: 'JVM/Web', file: '/posts/language/jvm/spring_framework.html', title: 'Spring Framework' },
        { category: 'JVM/Web', file: '/posts/language/jvm/spring_reactive.html', title: 'Web Reactive' },
        { category: 'JVM/Web', file: '/posts/language/jvm/spring_servlet.html', title: 'Web Servlet' },
        { category: 'Python', file: '/posts/language/python/basic.html', title: 'Python 3.8 시작하기' },
        { category: 'Python', file: '/posts/language/python/built_in_constant.html', title: 'Python Built-in Constants 3.8' },
        { category: 'Python', file: '/posts/language/python/built_in_exception.html', title: 'Python Built-in Exceptions 3.8' },
        { category: 'Python', file: '/posts/language/python/built_in_function.html', title: 'Python Built-in Functions 3.8' },
        { category: 'Python', file: '/posts/language/python/built_in_type.html', title: 'Python Built-in Types 3.8' },
        { category: 'Python', file: '/posts/language/python/data_model.html', title: 'Python 3.8 데이터 모델' },
        { category: 'Python', file: '/posts/language/python/persistence.html', title: 'Python Data Persistence' },
        { category: 'Python/Library', file: '/posts/language/python/pandas.html', title: 'pandas : 데이터 처리' },
        { category: 'Python/Library', file: '/posts/language/python/standard.html', title: '표준 라이브러리' },
