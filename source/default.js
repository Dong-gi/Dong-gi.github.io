const posts = {
    list: [
        { category: 'JVM', file: '/posts/java/index.html', title: 'Java Index' },
        ...
        { category: 'JVM', file: '/posts/java/javafx.html', title: 'JavaFX' },
        { category: 'JVM', file: '/posts/java/jni.html', title: 'Java Native Interface' },
        { category: 'JVM', file: '/posts/java/oop.html', title: 'Java 객체지향' },
        ...
        { category: 'JVM/3rd', file: '/posts/java/apache.commons.collections.html', title: 'Apache Commons Collections 4.4' },
        { category: 'JVM/3rd', file: '/posts/java/apache.commons.lang.html', title: 'Apache Commons Lang 3.9' },
        { category: 'JVM/3rd', file: '/posts/java/apache.commons.math.html', title: 'Apache Commons Math 3.6.1' },                       // 미완
        { category: 'JVM/3rd', file: '/posts/java/apache.commons.rng.html', title: 'Apache Commons RNG Core 1.2' },
        { category: 'JVM/3rd', file: '/posts/front/freemarker/built_in.html', title: 'FreeMarker Built-in 목록 2.3.28' },
        { category: 'JVM/3rd', file: '/posts/front/freemarker/programming_guide.html', title: 'FreeMarker 프로그래밍 가이드 2.3.28' },
        { category: 'JVM/3rd', file: '/posts/front/freemarker/template_guide.html', title: 'FreeMarker 템플릿 작성 가이드 2.3.28' },
        { category: 'JVM/3rd', file: '/posts/front/freemarker/xml_guide.html', title: 'FreeMarker XML 처리 가이드 2.3.28' },
        { category: 'JVM/3rd', file: '/posts/java/jackson.html', title: 'Jackson 2.10.1' },
        { category: 'JVM/3rd', file: '/posts/java/gson.html', title: 'Gson 2.8.6' },
        { category: 'JVM/3rd', file: '/posts/java/guava.html', title: 'Guava 23.0' },                                                    // 미완
        { category: 'JVM/3rd', file: '/posts/java/lombok.html', title: 'lombok 1.18.10' },
        { category: 'JVM/3rd', file: '/posts/java/logback.html', title: 'Logback with SLF4J' },
        { category: 'JVM/Standard', file: '/posts/java/java.base.html', title: 'java.base 12' },
        { category: 'JVM/Standard', file: '/posts/java/javax.annotation.processing.html', title: 'Annotation Processing API' },
        { category: 'JVM/Standard', file: '/posts/java/com.sun.nio.sctp.html', title: 'com.sun.nio.sctp Since 1.7' },
        { category: '인프라', file: '/posts/single/infra.html', title: 'Infra Index' },
        { category: '인프라', file: '/posts/single/aws.html', title: 'AWS' },
        { category: '인프라', file: '/posts/single/centos.html', title: 'CentOS' },
        { category: '인프라', file: '/posts/single/docker.html', title: 'Docker' },
        { category: '인프라', file: '/posts/single/git.html', title: 'Git' },
        { category: '인프라', file: '/posts/single/gradle.html', title: 'Gradle' },
        { category: '인프라', file: '/posts/single/nginx.html', title: 'Nginx' },
        { category: '인프라', file: '/posts/single/rpi.html', title: 'Raspberry Pi 3 + OpenCV(python)' },
        { category: '인프라', file: '/posts/single/sdkman.html', title: 'SDKMAN; The Software Development Kit Manager' },
        { category: '인프라', file: '/posts/single/tomcat.html', title: 'tomcat' },
        { category: '인프라/DB', file: '/posts/db/index.html', title: 'DB, Cache Index' },
        { category: '인프라/DB', file: '/posts/db/concept.html', title: 'DB 기초' },
        { category: '인프라/DB', file: '/posts/single/redis.html', title: 'Redis' },
        { category: '인프라/DB', file: '/posts/db/mongodb.html', title: 'MongoDB' },
        { category: '인프라/DB', file: '/posts/db/mysql.html', title: 'MySQL' },
        { category: '인프라/DB', file: '/posts/db/psql_to_sqlite.html', title: 'PostgreSQL → SQLite3 마이그레이션' },
        { category: '인프라/DB', file: '/posts/db/psql_admin.html', title: 'PostgreSQL 서버 관리' },
        { category: '인프라/DB', file: '/posts/db/psql_programming.html', title: 'PostgreSQL 서버 프로그래밍' },
        { category: '인프라/DB', file: '/posts/db/psql_tutorial.html', title: 'PostgreSQL 시작하기' },
        { category: '인프라/DB', file: '/posts/db/psql_sql.html', title: 'PostgreSQL SQL 언어' },
        { category: '토막글', file: '/posts/single/fp.html', title: 'FP; Functional Programming' },
        { category: '토막글', file: '/posts/algorithm/ai.html', title: 'AI' },
        { category: '토막글', file: '/posts/single/interview.html', title: '개발자 면접 준비' },
        { category: '토막글', file: '/posts/single/quantum_computer.html', title: '양자 컴퓨터' },
        { category: '토막글', file: '/posts/single/unity.html', title: 'Unity' },
        { category: '토막글', file: '/posts/single/vi.html', title: 'vi' },
        { category: '토막글', file: '/posts/single/refactoring.html', title: '디자인 패턴 + 리팩터링' },
        { category: '토막글/일반 도서', file: '/posts/book/001.html', title: '1만 시간의 재발견' },
        { category: '토막글/일반 도서', file: '/posts/book/002.html', title: '마음의 탄생' },
        { category: '토막글/일반 도서', file: '/posts/book/003.html', title: '생각하는 삶을 위한 철학의 역사' },
        { category: '토막글/일반 도서', file: '/posts/book/004.html', title: '쇼펜하우어, 돌이 별이 되는 철학' },
        { category: '토막글/일반 도서', file: '/posts/book/005.html', title: '인생의 모든 의미' },
        { category: '토막글/일반 도서', file: '/posts/book/006.html', title: '지식의 착각' },
        { category: '토막글/일반 도서', file: '/posts/book/007.html', title: '키르케고르 실존 극장' },
        { category: '토막글/일반 도서', file: '/posts/book/008.html', title: 'Gamification by Design' },
        { category: '토막글/일반 도서', file: '/posts/book/009.html', title: '인지 편향' },
        { category: '알고리즘', file: '/posts/algorithm/algo.html', title: '알고리즘 일반' },
        { category: '알고리즘', file: '/posts/algorithm/book01.html', title: '『알고리즘 도감』' },
        { category: '알고리즘', file: '/posts/algorithm/linear_algebra.html', title: '선형대수' },
        { category: '알고리즘', file: '/posts/algorithm/probability.html', title: '확률' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1003.html', title: '1003: 0을 만들자' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1008.html', title: '1008: 순환 소수' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1010.html', title: '소수(Prime) 관련 문제' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1011.html', title: '동적계획법(DP) 문제' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1018.html', title: '1018: 문자열 거리 최소화 하기' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1034.html', title: '1034,1041: 최소 이동 거리' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1048.html', title: '1048: AP 배분' },
        { category: '알고리즘/KOREATECH', file: '/posts/algorithm/koreatech/1095.html', title: '1095: 자연스러운 정렬' },
        { category: '.NET', file: '/posts/dotnet/index.html', title: '.NET Index' },
        { category: '.NET', file: '/posts/dotnet/csharp_basic.html', title: 'C# 기초' },
        { category: '.NET', file: '/posts/dotnet/csharp_library.html', title: 'C# 라이브러리' },
        { category: '.NET', file: '/posts/dotnet/wpf_basic.html', title: 'WPF 기초' },
        ...
        { category: 'JavaScript', file: '/posts/javascript/index.html', title: 'JavaScript Index' },
        ...
        { category: 'Python', file: '/posts/python/index.html', title: 'Python Index' },
        { category: 'Python', file: '/posts/python/basic.html', title: 'Python 3.8 시작하기' },
        { category: 'Python', file: '/posts/python/built_in_constant.html', title: 'Python Built-in Constants 3.8' },
        { category: 'Python', file: '/posts/python/built_in_exception.html', title: 'Python Built-in Exceptions 3.8' },
        { category: 'Python', file: '/posts/python/built_in_function.html', title: 'Python Built-in Functions 3.8' },
        { category: 'Python', file: '/posts/python/built_in_type.html', title: 'Python Built-in Types 3.8' },
        { category: 'Python', file: '/posts/python/data_model.html', title: 'Python 3.8 데이터 모델' },
        ...
        { category: '프로젝트', file: '/posts/project/sf.html', title: 'SF; Simplest html Framework' },
        { category: '프로젝트', file: '/posts/project/wpf_data_tool.html', title: 'C#.NET, WPF - 데이터 작업 툴' },
    ], codes: {}
}
