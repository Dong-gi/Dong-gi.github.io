...
2. Wi-Fi 핫스팟이 필요할 때만 **SSID**와 **패스프레이즈**(8–63자)를 입력하고 **Start hotspot** 탭. 핫스팟은 배터리 소모가 크므로 기본은 꺼져 있고, 필요할 때만 켰다 끕니다.
...
- **HTTP 프록시는 인증 없음**: 누구나 192.168.49.1:8282에 접근 가능. Wi-Fi 패스프레이즈가 사실상 유일한 접근 통제선.
