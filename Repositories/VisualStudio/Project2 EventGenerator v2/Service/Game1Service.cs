...
namespace EventGenerator.Service
{
    class Game1Service
    {
        ...
        private void AddSheet<T>(IEnumerable<T> items, bool addSheetWhenListEmpty = false, bool allowDuplicateSheets = false)
            => Context.AddSheet(items, addSheetWhenListEmpty, allowDuplicateSheets);
        ...
        public Game1Service MakeTable1(IEnumerable<Table1> items)
        {
            AddSheet(items);
            return this;
        }
