...
namespace EventGenerator.Model
{
    abstract class BaseContext
    {
        ...
        public void AddSheet<T>(IEnumerable<T> items, bool addSheetWhenListEmpty = false, bool allowDuplicateSheets = false) =>
            Excel.AddSheet(CustomExcelDataUtility.ConvertToExcelData(AddItems(items), returnAnyway: addSheetWhenListEmpty), allowDuplicateSheets);
